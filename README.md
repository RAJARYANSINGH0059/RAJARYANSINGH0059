...
<a href="https://github.com/RAJARYANSINGH0059">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&duration=3200&pause=900&center=true&vCenter=true&multiline=true&width=900&height=100&lines=Hey!+I'm+Raj+Aryan+Singh+%F0%9F%91%8B;ECE+%7C+AI%2FML+%7C+Software+%7C+Embedded+Systems;I+build%2C+break%2C+debug%2C+and+build+again+%E2%9A%A1" alt="Typing introduction" />
</a>
...
📍 Delhi, India  
🎓 B.Tech ECE — University of Delhi, Faculty of Technology  
🤖 AI/ML learner + builder  
...
|---|---|
| 🤖 AI / ML | Machine learning, NLU, data-driven systems |
| 💻 Software | Python, web apps, APIs, backend systems |
| ⚡ Embedded | Bluetooth, communication systems, firmware concepts |
| 📊 Data | Pandas, Excel, visualization, analytical thinking |
| 🏦 FinTech | Payments, financial analysis, business analysis, quant research |
| 🧪 Hackathons | Rapid prototyping, product thinking, demos, pitching |
...
|---|---|---|
| 🛡️ **Project Aegis** | Decentralized Bluetooth Mesh Communication Cyberdeck | Bluetooth • Embedded • Communication • Firmware |
| 📦 **Trust-Tag** | Logistics pilferage detection system | AI/ML • Logistics • Detection • Product Design |
| ⚡ **KERS** | Kinetic Energy Recovery System | Electronics • Energy Systems • Hardware |
| ☁️ **Tropical Cloud Cluster Identification System** | Satellite-data based cloud-cluster identification | Satellite Data • Remote Sensing • Python • Data Analysis |
| 👥 **CrowdTwin AI** | Crowd simulation + AI-assisted intervention decision support | React • TypeScript • FastAPI • NetworkX • Simulation |
...
> I don't want to stay in one box. I want to become good at making the **boxes talk to each other**.
...
> **2. Prototype before over-engineering.**  
> **3. Test assumptions instead of defending them.**  
> **4. Make the demo work — then make the architecture better.**  
> **5. Learn the underlying system, not just the library.**
